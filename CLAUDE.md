...
> Entry: `.claude/ai_context/development/v7/implementation/00_INDEX.md` · Live cursor: `…/STATUS.md`
> · Blueprint: `…/v7/GRANDPLAN.md (v2–v6 = base, still binding)` · Locked decisions: `…/DECISIONS.md` · Raw intent:
