...
> Entry: `.claude/ai_context/development/v6/implementation/00_INDEX.md` · Live cursor: `…/STATUS.md`
> · Blueprint: `…/v6/GRANDPLAN.md (v2–v5 = base, still binding)` · Locked decisions: `…/DECISIONS.md` · Raw intent:
