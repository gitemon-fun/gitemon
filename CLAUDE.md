...
> Entry: `.claude/ai_context/development/v8/implementation/00_INDEX.md` · Live cursor: `…/STATUS.md`
> · Blueprint: `…/v8/GRANDPLAN.md (v2–v7 = base, still binding)` · Locked decisions: `…/DECISIONS.md` · Raw intent:
